...
public class MainActivity extends AppCompatActivity
        ...
        , TasksView.OnFragmentInteractionListener, TaskDetail.OnFragmentInteractionListener {

    //The fragments
    private Fragment tasksList;
    /**
    ...
    //Method to implement go back from fragment to the first.
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Toast.makeText(MainActivity.this, "Settings touch", Toast.LENGTH_SHORT).show();
            return true;
        }
